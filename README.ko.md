...
- npm 패키지 배포 완료: `@jaewon94/ai-setting@1.1.8`
- GitHub Releases 사용 중
- Homebrew 자동화는 준비됐고 tap 배포는 별도 진행

## 왜 README를 줄였나

README는 첫 진입 문서여야 하고, 전체 운영 매뉴얼이 되면 읽기 시작하기가 너무 무거워집니다.

예전처럼 길었던 상세 설명은 이제 아래 문서로 옮겼습니다.
- [docs/usage.ko.md](docs/usage.ko.md)
- [docs/reference.ko.md](docs/reference.ko.md)
- [docs/deployment-checklist.md](docs/deployment-checklist.md)

구현 세부가 필요하면 그 문서로 바로 들어가면 됩니다.
