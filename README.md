...
- npm package published: `@jaewon94/ai-setting@1.1.8`
- GitHub Releases active
- Homebrew automation prepared, tap rollout still separate

## Why the README Is Shorter Now

The README is intentionally the entry document, not the full manual.

Detailed material that used to make this file hard to scan now lives in:
- [docs/usage.md](docs/usage.md)
- [docs/reference.md](docs/reference.md)
- [docs/deployment-checklist.md](docs/deployment-checklist.md)

If you need implementation detail, go there directly.
